...
function updateFreight() {
    var freightElement = document.getElementById('freight');
    var selectedFreight = freightElement.value;
    var freightPrice = 0;

    if (selectedFreight === 'standard') {
        freightPrice = 20.00;
    } else if (selectedFreight === 'express') {
        freightPrice = 40.00;
    }

    var totalPriceElement = document.getElementsByClassName("total-price")[0];
    var totalWithoutFreight = parseFloat(totalPriceElement.innerHTML.replace("R$", "").replace(",", "."));
    var totalWithFreight = totalWithoutFreight + freightPrice;

    var freightPriceElement = document.getElementById('freight-price');
    freightPriceElement.innerHTML = `Frete: R$ ${freightPrice.toFixed(2).replace(".", ",")}`;
    totalPriceElement.innerHTML = `R$ ${totalWithFreight.toFixed(2).replace(".", ",")}`;
}
